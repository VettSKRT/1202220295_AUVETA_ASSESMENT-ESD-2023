def dekripsi_pesan(pesan_terenkripsi):
    ...
    for huruf in pesan_terenkripsi:
        ...
        if huruf.isalpha():
            # Ganti huruf berdasarkan aturan pergeseran 5 karakter dalam abjad
            ...
            pesan_terdekripsi += huruf  # Jika bukan huruf, tambahkan karakter aslinya
    return pesan_terdekripsi

# Pesan-pesan terenkripsi
pesan_terenkripsi = [
    "xfqfr bfmdz",
...
# Memecahkan pesan-pesan terenkripsi
